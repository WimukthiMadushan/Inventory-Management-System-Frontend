...
const SendToTrashModal = ({ open, onCancel, items, onSend }) => {
  ...
  return (
    ...
    >
      <Form layout="vertical" form={form} onFinish={handleSubmit}>
        ...
        {/* To (fixed Trash) */}
        <Form.Item name="to" initialValue="Trash" hidden>
          <Input />
        </Form.Item>

        <Form.Item label="To">
          <Input disabled value="Trash" />
        </Form.Item>
      </Form>
    </Modal>
  );
...
export default SendToTrashModal;
